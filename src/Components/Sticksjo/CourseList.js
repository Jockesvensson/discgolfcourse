    ...
    return (
        ...
        <div className="course-test-container">
          <div className="course-test-wrapper">
            {Object.entries(CourseData).map(([slug, { name, lenght, altLenght, par, metersLeft, blackSign, graySign, well, dropZone, mando, stone, ob, image, src }]) => (
              <div key={slug}>
                <div className="course-test-title">{name}</div>
                  <div className="course-test-info">
                    ...
                    <div className="course-right-item gray-bg">
                        ...
                        <div className="">
                            <Link to={`/sticksjo/course/${slug}`} style={{ textDecoration: 'none', color: 'white'}} onClick={scrollTop}>
